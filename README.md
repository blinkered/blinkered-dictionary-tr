# Blinkered dictionary: Turkish

The Turkish word list, and the evidence for every word in it.

Built by [`blinkered-attestation`](https://github.com/blinkered/blinkered-attestation). The rule,
the evidence format and the reasoning live there; what lives here is Turkish.

**327,920 of 638,282 candidates proved — 51.4%**, across 6 independent
families, 4 of which a stranger could check by fetching.

## What is in this repository

```
sources.mjs        which collections attest Turkish, and why those
...
Candidates come from Blinkered's Turkish list, which lives in
[`blinkered-attestation/candidates/tr`](https://github.com/blinkered/blinkered-attestation/tree/main/candidates/tr).
...
file a subset of that dictionary and it carries that dictionary's terms — here `MIT`.
